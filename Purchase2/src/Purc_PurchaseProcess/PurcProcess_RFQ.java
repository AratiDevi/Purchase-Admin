...
public class PurcProcess_RFQ extends RW{
	...
	public void Search(WebDriver driver1) throws Exception {
		...
		WebDriver driver = driver1;
	     ...
	     ArrayList<Row> row= OR_Purchase_m.searchSheet("Search_RFQ",0,9);
	    ArrayList<Row> row1=input_purc_m.searchSheet("Search_RFQ", 0,0);
	...
	public void QuotationEvaluation(WebDriver driver1) throws Exception {
		WebDriver driver = driver1;		

		
		
		 ArrayList<Row> row= OR_Purchase_m.searchSheet("QuotationEvalution",0,9);

		    ArrayList<Row> row1=input_purc_m.searchSheet("QuotationEvalution", 0,0);
	...
	public void DeclineQuote(WebDriver driver1) throws Exception {
		WebDriver driver = driver1;		

		
		
		 ArrayList<Row> row= OR_Purchase_m.searchSheet("DeclineQuote",0,9);

		    ArrayList<Row> row1=input_purc_m.searchSheet("DeclineQuote", 0,0);
	...
	public void ImportExcelQuotation(WebDriver driver1) throws Exception {
		WebDriver driver = driver1;		

		
		
		 ArrayList<Row> row= OR_Purchase_m.searchSheet("ImportExcelQuotation",0,9);

		    ArrayList<Row> row1=input_purc_m.searchSheet("ImportExcelQuotation",0,0);
	...
	public void SendtoSuptdforApproval(WebDriver driver1) throws Exception {
		WebDriver driver = driver1;		

		
		
		 ArrayList<Row> row= OR_Purchase_m.searchSheet("SendtoSuptdforApproval",0,9);

		    ArrayList<Row> row1=input_purc_m.searchSheet("SendtoSuptdforApproval",0,0);
