...
public class PurcProcess_ApprovedQuotation extends RW{
	...
	public void Search(WebDriver driver1) throws Exception {
		...
		WebDriver driver = driver1;
	     ...
	     ArrayList<Row> row= OR_Purchase_m.searchSheet("Approve_Quotation",0,9);


	    ArrayList<Row> row1=input_purc_m.searchSheet("Approve_Quotation", 0,0);


	 	
	    
	    //URL Path Concat
		String input_purc_URL =url.concat(input_purc_m.getData(0, 93, 2));
	...
	public void RaisePO(WebDriver driver1) throws Exception {

		 	
		WebDriver driver = driver1;

	     ArrayList<Row> row= OR_Purchase_m.searchSheet("RaisePO",0,9);

	    ArrayList<Row> row1=input_purc_m.searchSheet("RaisePO", 0,0);
	...
	public void ViewQuotations(WebDriver driver1) throws Exception {
		...
		WebDriver driver = driver1;
	     ...
	     ArrayList<Row> row= OR_Purchase_m.searchSheet("ViewQuotations",0,9);

	    ArrayList<Row> row1=input_purc_m.searchSheet("ViewQuotations", 0,0);
	...
	public void CancelPO(WebDriver driver1) throws Exception {
		...
		WebDriver driver = driver1;
	     ...
	     ArrayList<Row> row= OR_Purchase_m.searchSheet("CancelPO",0,9);

	    ArrayList<Row> row1=input_purc_m.searchSheet("CancelPO", 0,0);
