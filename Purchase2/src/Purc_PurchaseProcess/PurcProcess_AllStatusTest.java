...
public class PurcProcess_AllStatusTest extends WebDriverPass{
	ExtentReports report;
	ExtentTest test;
	PurcProcess_AllStatus p=new PurcProcess_AllStatus();
	...
	@Test(priority=2)
	  public void ViewAuditTrailSummary() throws Exception {
		  test=report.startTest("Purchase Process _ New Reqsn"); 
		  
		  p.ViewAuditTrailSummary(driver);
		  Assert.assertTrue(true);
	      test.log(LogStatus.PASS, "Purchase-->Purchase Process-->New Reqsn-->Search Functionality"); 
